      ...
      <header style={{ position: "sticky", top: 0, zIndex: 50, background: "rgba(244,238,227,0.86)", backdropFilter: "blur(12px)", borderBottom: "1px solid #E7DECE" }}>
        <div className="construction-header-inner" style={{ maxWidth: 1180, margin: "0 auto", padding: "0 28px", height: 82, display: "flex", alignItems: "center", justifyContent: "space-between", gap: 24 }}>
          <a href="/" style={{ display: "flex", alignItems: "center", gap: 11, textDecoration: "none", color: "#211C15" }}>
            <img className="construction-header-logo" src="/brooker-mark-160.webp" alt="" style={{ width: 58, height: 58, borderRadius: 0, objectFit: "contain" }} />
        ...
        <div className="landing-hero-inner" style={{ maxWidth: 1180, margin: "0 auto", padding: "clamp(34px,6vw,78px) 28px clamp(42px,6vw,74px)", position: "relative", display: "grid", gridTemplateColumns: "minmax(0, 1fr) minmax(400px, 420px)", gap: "clamp(32px,6vw,72px)", alignItems: "center" }}>
          ...
          <aside className="construction-profile-card" style={{ background: "#FFFFFF", border: "1px solid #EFE6D6", borderRadius: 24, padding: 28, boxShadow: "0 24px 60px -40px rgba(33,28,21,0.45)", minWidth: 0, boxSizing: "border-box" }}>
            ...
            <div className="construction-profile-row" style={{ display: "flex", alignItems: "center", gap: 24, marginBottom: 24 }}>
              <img className="construction-profile-image" src="/max-brooker-640.webp" alt="Max Brooker" style={{ width: 168, height: 168, borderRadius: 30, objectFit: "cover", objectPosition: "top", border: "1px solid #E7DECE" }} />
              <div>
